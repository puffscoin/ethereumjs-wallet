...
var puffsUtil = require('puffscoinjs-util')
...
describe('.generate()', function () {
  ...
  it('should generate an account compatible with ICAP Direct', function () {
    ...
    assert.strictEqual(new puffsUtil.BN(wallet.getAddress()).lte(max), true)
  })
})
...
describe('.fromPuffsSale()', function () {
  ...
  it('should work with pyethrecover\'s wallet', function () {
    var json = '{"encseed": "8b4001bf61a10760d8e0876fb791e4ebeb85962f565c71697c789c23d1ade4d1285d80b2383ae5fc419ecf5319317cd94200b65df0cc50d659cbbc4365fc08e8", "puffsaddr": "83b6371ba6bd9a47f82a7c4920835ef4be08f47b", "bkp": "9f566775e56486f69413c59f7ef923bc", "btcaddr": "1Nzg5v6uRCAa6Fk3CUU5qahWxEDZdZ1pBm"}'
    var wallet = Wallet.fromPuffsSale(json, 'password123')
